    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/elizavetanovozhilova/foodgram-st.git" target="_blank" rel="noopener noreferrer" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/elizavetanovozhilova/" target="_blank" rel="noopener noreferrer" className={styles.textLink}>Елизавета Новожилова</a>
            </p>
            <p className={styles.textItem}>
              <a href="/technologies" className={styles.textLink}>Технологии проекта</a>
            </p>
          </div>
        </aside>
      </div>
